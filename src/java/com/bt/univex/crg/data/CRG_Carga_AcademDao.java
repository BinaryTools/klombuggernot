...
public class CRG_Carga_AcademDao extends BaseDao {

    private void initializeDao() { 
        TableName = "CRG_Carga_Academ";
        PkeyName = "PkeyCargAcad";
        DescName = "null";
        CodeName = "null";
        AliasName = "CargAcad";
        deepLevel = 2;
        setXPracPkeyEnti(7803);
        loadInfoEntity();
    }

    public CRG_Carga_AcademDao(BaseConnection connect) {
        super();
        initializeDao();
        this.setDataConnect(connect);
    }

    public CRG_Carga_AcademDao() {
        super();
        initializeDao();
        this.setDataConnect(new Connect());
    }

  public static CRG_Carga_AcademDto getDefaultDto()  {
     CRG_Carga_AcademDto dto = new CRG_Carga_AcademDto(); 
    ...
    public BaseDto getBasicDto() {
        return new CRG_Carga_AcademDto();
    }
...
//-------------------------------------------------------- INFO DTo
  ...
  public BaseDto userLoadDto(BaseDto dto,ResultSet rs )  throws SQLException {
    CRG_Carga_AcademDto newDto = (CRG_Carga_AcademDto) dto;
    if (getDeepLevel() != 0) {
...
//      DEF_PeriodPlanesDao fkeyPeriPlanDao = new DEF_PeriodPlanesDao(); 
//      newDto.setFkeyPeriPlanDto((DEF_PeriodPlanesDto)fkeyPeriPlanDao.findDtoByPkey(new Integer(rs.getInt("fkeyPeriPlan")), getDeepLevel()-1));
