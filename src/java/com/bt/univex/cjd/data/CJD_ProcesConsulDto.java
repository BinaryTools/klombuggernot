...
public class CJD_ProcesConsulDto extends BaseDto {
  ...
  public CJD_ProcesConsulDto() { 
     PkeyEnti = 128403;
     setAliasName("ProcCons"); 
  } 
...
//---------------------(REL: FkeyDoceEspeDto) 
  ...
  @Override 
  public CJD_ProcesConsulDto copy(){
    CJD_ProcesConsulDto result = new CJD_ProcesConsulDto();
